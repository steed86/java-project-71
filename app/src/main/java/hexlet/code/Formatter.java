...
public class Formatter {
    ...
    public static String resultStringBuilderStylish(String currentResult, String key, Object oldValue, Object newValue,
                                                    String resultCode) {
        var newResult = "";
    ...
    public static String resultStringBuilderPlain(String currentResult, String key, Object oldValue, Object newValue,
                                                  String resultCode) {
        var newResult = "";
    ...
    public static String formatDifferResult(HashMap<String, HashMap<String, Object>> differResult, String format) {
        ...
        if (format.equals("stylish")) {
            ...
            for (var key : keys) {
                ...
                result = resultStringBuilderStylish(result, key, currentResultMap.get("old"),
            ...
            for (var key : keys) {
                var currentResultMap = differResult.get(key);
                var currentResultCode = String.valueOf(currentResultMap.get("result"));
                result = resultStringBuilderPlain(result, key, currentResultMap.get("old"), currentResultMap.get("new"),
                        currentResultCode);
            }
        }
