...
public class Parser {
    public static Map<String, String> getMapFromFile(String filepath) throws Exception {
        ...
        if (fileFormat.equals("json")) {
            ...
            result = objectMapper.readValue(fileTxt, new TypeReference<Map<String, String>>() {
            });
        } else if (fileFormat.equals("yml")) {
            if (!(fileTxt.isEmpty())) {
                //если файл не пустой, то десериализуем его
                ObjectMapper objectMapper = new YAMLMapper();
                return objectMapper.readValue(fileTxt, new TypeReference<Map<String, String>>() {
                });
            }
        }
